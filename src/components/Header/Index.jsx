          ...
          <div className={styles.headerPadding}>
            ...
            {value ? (
              <ul className={styles.headerRecommendKeyword} ref={ulRef}>
                <div className={styles.headerRecommendKeywordListItem}>
                          ...
                          <div>
                            {item.keywords.map((keyword, index) => (
                              <div
                                ...
                                onClick={() =>
                                  handleClickRecommendKeyWord(keyword.keyword)
                                }
                              >
                                <div
                                  className={styles.headerRecommendKeywordIcon}
                                >
                                  <FontAwesomeIcon icon="fa-solid fa-magnifying-glass" />
                                </div>
                            ...
                            {item.suggestions.map((suggest, index) => (
                              ...
                              >
                                <div className={styles.headerSuggestThumbnail}>
                                  <div
                                    className={styles.headerSuggestThumbnailImg}
                                    style={{
                                      backgroundImage: `url(${
                                        suggest.avatar || suggest.thumb
                                      })`,
                                      borderRadius: `${
                                        suggest.type === 4 ? "50%" : "5px"
                                      }`,
                                    }}
                                  ></div>
                                </div>
                                <div className="ms-2">
                                  ...
                                  {suggest.type === 4 ? (
                                    ...
                                    >
                                      Nghệ sĩ •{" "}
                                      {formatFollow(suggest.followers)}
                                    </div>
                                  ) : suggest.type === 5 ? (
                                    <div
                                      style={{
              ...
              <ul className={styles.headerRecommendKeyword} ref={ulRef}>
                <div className={styles.headerSearchTitle}>Đề xuất cho bạn</div>
                {loading ? (
                  <div className="mv-loading-more">
                    <ReactLoading
                      type="spin"
                  ...
                  <div>
                    {recommendKeyword.map((item, index) => (
                      <div
                        ...
                        style={{ padding: "8px 10px", borderRadius: "8px" }}
                        onClick={() =>
                          handleClickRecommendKeyWord(item.keyword)
                        }
                      >
                        <div className={styles.headerRecommendKeywordIcon}>
