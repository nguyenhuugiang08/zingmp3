    ...
    <div>
      {loading ? (
        ...
        <div className={styles.Album}>
                ...
                <div className={styles.albumScroll}>
                  ...
                  <div className={styles.albumTitleBox}>
                    <div className={styles.albumTitleLeft}>
                      ...
                      <span style={{ marginLeft: "10px" }}>BÀI HÁT</span>
                    </div>
                  ...
                  >
                    ...
                    <div>{`${Math.floor(sumDuration / 3600)} giờ ${Math.floor(
                      (sumDuration - Math.floor(sumDuration / 3600) * 3600) / 60
                    )} phút`}</div>
                  </div>
                </div>
              </Col>
          ...
          {suggestPlaylist.length > 0 &&
          suggestPlaylist.includes(
            suggestPlaylist.filter((item) => item.sectionType === "playlist")[0]
          ) ? (
