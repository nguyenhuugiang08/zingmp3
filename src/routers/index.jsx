...
function Routerall() {
  ...
  return (
    <div style={{ width: 'calc(100% - 240px)', position: 'relative', left: '240px', padding: '70px 60px 0', top: '0', marginBottom: `${mounted ? "90px" : ""}`, backgroundColor: '#170f23', minHeight: 'calc(100vh - 90px)' }}>
      <Routes>
