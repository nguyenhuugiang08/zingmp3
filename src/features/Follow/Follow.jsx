...
function Follow() {
    ...
    const handleFilterType = (e, type) => {
        ...
        setId(type === 'vn' ? 'IWZ9Z08I' : (type === 'usuk' ? 'IWZ9Z08O' : (type === 'kpop' ? 'IWZ9Z08W' : 'IWZ9Z08U')))
        const list = []
        setList(list)
        setPage(1)
    }
    ...
    return (
        <div className='follow'>
            <div className='follow-filter'>
                <div className='follow-filter__item follow-filter__item--active'
                    onClick={(e) => handleFilterType(e, 'vn')}
                >VIỆT NAM</div>
                <div className='follow-filter__item'
