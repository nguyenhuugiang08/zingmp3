            ...
            {list.map((section, index) => (
                <div className='genre-detail-wrapper' key={index}>
                    <div className={`${styles.mainTitle} `}>
                        <div
                            className={`${styles.top100OutstandingTiltle} ps-0 mb-3`}
                        >
                            {section.title}
                        </div>
                    </div>
                    ...
                    >
                                ...
                                <div>
                                    {index > 4 ? (
                                        ...
                                        <SwiperSlide key={item.encodeId}>
                                            <div
                                                className={
                                                    styles.top100OutstandingPar
                                                }
                                            >
                                                <div
                                                    className={
                                                        styles.top100OutstandingImage
                                                    }
                                                    style={{
                                                        ...
                                                        item.artists.map(
                                                            (artist, index) => (
                                                                <div
                                                                    ...
                                                                    className={
                                                                        styles.top100OutstandingArtist
                                                                    }
                                                                >
                                                                    <NavItem>
                                                                        <Link
                        ...
                        data.sections &&
                        data.sections.filter(
                            (section) => section.sectionType === "song"
                        ).length > 0 ? (
                        ...
                        data.sections &&
                        data.sections.filter(
                            (section) => section.sectionType === "video"
                        ).length > 0 ? (
                        ...
                        data.sections &&
                        data.sections.filter(
                            (section) => section.sectionType === "artist"
                        ).length > 0 ? (
