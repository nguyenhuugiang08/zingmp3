            ...
            {list.map(mv => (
                <div>
                    <div className={style.mainTitle}>
                        <div className={`${style.top100OutstandingTiltle} ps-0`}>{mv.title}</div>
                    </div>
                                ...
                                <SwiperSlide key={index}>
                                    <div className={style.top100OutstandingCol}>
                                        <div className={style.top100OutstandingPar}>
                                            <div className={style.top100OutstandingMv} style={{ backgroundImage: `url(${item.thumbnailM})` }}>
                                            </div>
                                        ...
                                        <div className=' d-flex justify-content-start align-items-center mt-1'>
                                            <div style={{ width: '40px', height: '40px', position: 'relative', top: '3px' }}>
                                                <div className={style.top100OutstandingMvImg}
                                                 style={{ backgroundImage: `url(${item.artist && item.artist.thumbnail})` }}></div>
                                            </div>
                                            <div className='ms-2'>
