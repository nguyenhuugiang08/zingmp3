    ...
    return (
        <>
            {prop === 1 ?
                ...
                <>
                    <div> <Skeleton baseColor='#231B2E' highlightColor='#231B2E' height={184} /> </div>
                    <div> <Skeleton baseColor='#231B2E' highlightColor='#231B2E' height={32} /> </div>
                </>
            }
        </>
...
function Loading() {
    return (
        <div>
            <Container>
                <Row xs={3}>
                    <Col> <Skeleton baseColor='#231B2E' highlightColor='#231B2E' height={210} /> </Col>
                    <Col> <Skeleton baseColor='#231B2E' highlightColor='#231B2E' height={210} /> </Col>
                    <Col> <Skeleton baseColor='#231B2E' highlightColor='#231B2E' height={210} /> </Col>
                </Row>
            </Container>
