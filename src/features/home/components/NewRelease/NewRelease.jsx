                                ...
                                <Col key={song.encodeId} xs={4}>
                                    <div className='new-release__song'>
                                        ...
                                        >
                                            ...
                                            <FontAwesomeIcon className='new-release__song--wrapper-icon' icon="fa-solid fa-play" />
                                        </div>
                                        <div className='new-release__song-info'>
                                            <div className='new-release__song-info__title'>{song.title}
                                                {!song.isWorldWide ? <div className='new-release__song-vip' >
