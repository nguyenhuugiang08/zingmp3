  ...
  function Content({ list }) {
    return (
      <div className={styles.Album}>
        ...
        <div className="zingchart_rank-header-title ms-3 mb-3">
          Bảng Xếp Hạng Tuần
        </div>
        <div className="d-flex justify-content-start align-items-center ms-3 py-5">
          <div className="me-3 zingchart_filter zingchart_filter--active">
            VIỆT NAM
          </div>
  ...
  return (
    <Content
      list={
        ...
        zingchartData[0].weekChart.vn.playlistId === encodeId
          ? vn
          : zingchartData[0].weekChart.us.playlistId === encodeId
          ? usuk
          : korea
      }
    />
