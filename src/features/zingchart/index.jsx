      ...
      <div>
        {list.map((item, index) =>
          index > 4 ? (
            ...
            <div
              key={index}
              className={`${styles.albumWrapper} zingchart_wrapper`}
            >
              <div className={`${styles.albumLeft} chart-left`}>
                <div className={`zingchart_count chart-left-count`}>{index + 1}</div>
              ...
              <div className={`${styles.albumRight} ms-3 chart-right`}>
        ...
        <div className={styles.Album}>
            ...
            <Row>
              <Col xs={12}>
                <div>
                  ...
                  <div className="zingchart_showall">
                    <span onClick={handleDisplaySongs}>Xem top 100</span>
                  </div>
                </div>
              </Col>
            </Row>
          ...
          <div className="mt-5 zingchart_rank">
            ...
            <div className="zingchart_rank-header">
              <Row>
                <Col xs={12} className="zingchart_rank-header-title chart-title">
                ...
                <Col md={12} lg={4} className="mb-3">
                  <div className="zingchart_rank-header-bg">
                    <div className="zingchart_rank-header-name">
                      Việt Nam
                      <div
                        className={`${styles.albumImagePar} zingchart_rank-header-name__icon`}
                        onClick={() =>
                          handleClick({
                    ...
                    <Link
                      to={
                        ...
                        `${zingchartData[0].weekChart.vn.link}/${zingchartData[0].weekChart.vn.playlistId}`
                      }
                      onClick={() =>
                        handleClickLink(
                          zingchartData[0].weekChart.vn.link,
                          "chart"
                        )
                      }
                      className="zingchart_rank-header-all mt-3"
                    >
                      Xem tất cả
                    </Link>
                  </div>
                ...
                <Col md={12} lg={4} className="mb-3">
                  <div className="zingchart_rank-header-bg">
                    ...
                    <Link
                      ...
                      onClick={() =>
                        handleClickLink(
                          zingchartData[0].weekChart.us.link,
                          "chart"
                        )
                      }
                      className="zingchart_rank-header-all mt-3"
                ...
                <Col md={12} lg={4} className="mb-3">
                  <div className="zingchart_rank-header-bg">
                    ...
                    <Link
                      to={
                        zingchartData.length > 0 &&
                        `${zingchartData[0].weekChart.korea.link}/${zingchartData[0].weekChart.korea.playlistId}`
                      }
                      onClick={() =>
                        handleClickLink(
                          zingchartData[0].weekChart.korea.link,
                          "chart"
                        )
                      }
                      className="zingchart_rank-header-all mt-3"
