                        ...
                        >
                            <div className={`${styles.albumLeft} chart-left`}>
                                ...
                                <div className={styles.albumArtistMain}>
                                    <div
                                        className={`vn_title ${styles.albumSongTitle}`}
                                    >
                                        {item.title}
                                    </div>
                                    <div
                                        className={`${styles.albumSongArtist} `}
                                    >
                            ...
                            <div
                                className={`${styles.albumRight} ms-3 chart-right`}
                            >
                            ...
                            <Col xs={12}>
                                <div>
                                    {data.map((song, index) => (
                                        ...
                                        >
                                            <div
                                                className={`${styles.albumLeft} chart-left`}
                                            >
                                                <div
                                                    className={`zingchart_count chart-left-count ${
                                                        index === 0
                                    ...
                                    <div className='zingchart_showall'>
                                        <span onClick={handleDisplaySongs}>
                                            Xem top 100
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div className='mt-5 zingchart_rank'>
                        ...
                        <div className='zingchart_rank-header'>
                            <Row>
                                <Col
                                    xs={12}
                                    className='zingchart_rank-header-title chart-title'
                                >
