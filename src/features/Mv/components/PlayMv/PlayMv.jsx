                  ...
                  <div className="playmv-container__wrapper">
                    <div className="playmv-container-box">
                      <div
                        ...
                        style={{
                          backgroundImage: `url(${
                            data.artists && data.artists[0].thumbnail
                          })`,
                        }}
                      ></div>
                    </div>
                    ...
                    {loading ? (
                      ...
                      >
                        <ReactPlayer
                          ref={videoRef}
                          url={`${
                            data.streaming && data.streaming.mp4["720p"]
                          }`}
                          playing={!isplay}
                          controls={false}
                          volume={volume}
                        ...
                        <div className="player d-none" ref={playerRef}>
                          <div className="player-custom-progress">
                            <input
                              ...
                              min={0}
                              max={100}
                              className="player-custom-progress-input ms-3 me-5"
                          ...
                          >
                            <div className="list-mv__content-box">
                              <div
                                ...
                                onClick={() =>
                                  handleLoadCurrentVideo(song.encodeId)
                                }
                              ></div>
                            </div>
                            <div
